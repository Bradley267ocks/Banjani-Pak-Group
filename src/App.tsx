        ...
        <div className="space-y-8">
          ...
          <ul className="space-y-4 text-brand-gray-med text-xs font-black uppercase tracking-widest">
            {[
              ...
              <li key={item.name}>
                <Link to={item.path} className="hover:text-white transition-colors flex items-center gap-3 group">
        ...
        <div className="space-y-8">
          ...
          <ul className="space-y-6 text-brand-gray-med text-sm font-bold tracking-widest">
            ...
            <li className="flex items-center gap-4 text-xs font-bold group">
              ...
              <a href="mailto:rogerm@banjanipg.co.za" className="hover:text-brand-primary transition-colors">rogerm@banjanipg.co.za</a>
            </li>
          ...
          <div className="relative aspect-square bg-white rounded-[3rem] p-8 shadow-xl border border-brand-primary/5 flex items-center justify-center overflow-hidden mb-8">
            ...
            <div className="absolute inset-0 bg-brand-primary/90 flex flex-col items-center justify-center opacity-0 group-hover:opacity-100 transition-all duration-500 transform translate-y-full group-hover:translate-y-0 p-8 text-center text-white">
              ...
              <a 
                ...
                className="px-6 py-2 border border-white rounded-full text-[10px] font-black uppercase tracking-widest hover:bg-white hover:text-brand-primary transition-all cursor-pointer"
              >
                Inquire Now
              </a>
            </div>
...
const ContactPage = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await fetch("https://formsubmit.co/ajax/rogerm@banjanipg.co.za", {
        method: "POST",
        headers: { 
        ...
        <div className="space-y-12 sm:space-y-20">
          ...
          <div className="space-y-8 sm:space-y-12">
            {[
              ...
              { icon: Instagram, label: "WhatsApp Chat", val: "Message Roger", link: "https://wa.me/27768910189", highlight: true },
...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-brand-light text-brand-text selection:bg-brand-primary selection:text-white font-sans overflow-x-hidden">
      ...
      >
        <span className="font-black uppercase tracking-[0.1em] text-[10px] hidden md:block">WhatsApp Roger</span>
